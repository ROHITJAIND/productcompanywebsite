    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                Copyright &copy;2022 Developed by ROHIT JAIN D</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ph2{
            background-image: url(/static/img/13.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
...
<html lang="en">
    <head>
        ...
        .manph1{
            background-image: url(/static/img/11.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph1{
            background-image: url(/static/img/14.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph2{
            background-image: url(/static/img/10.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
            ...
            <div class="header">
                ...
                <div class="content">
                    ...
                    <p><b>&emsp;&ensp;Address:</b>
                         No:3/40-c,Mohan Street,Gandhi Nagar,Chennai,Tamil Nadu
                    </p>
                    <ul>
                        <li><b>phone: 35695879484</b></li>
                        <li><b>shop owner no</b>: 3658755746</li>
                        <li><b>Shop Manager Number:</b> 35658547566</li>
                        <li><b>Email Id:</b>example@gmail.com</li>
                        <li><b>Email Id:</b>example@gmail.com</li>
                    </ul>
